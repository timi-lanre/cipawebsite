...
export default function MissionSection() {
  return (
    <section className="flex flex-col items-center justify-center px-4 pt-5">
      ...
      {/* Mission Box */}
      <div className="w-full max-w-3xl border-2 rounded-lg p-8 bg-white shadow-md">
        <blockquote className="text-left text-lg italic">
          <Quote className="inline-block w-4 h-4 text-gray-500 mr-1 mb-4" />
          <span>To empower immigrant professionals by providing personalized coaching,
