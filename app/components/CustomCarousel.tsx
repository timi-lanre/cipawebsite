        ...
        <div className="absolute w-full h-full transition-opacity duration-700">
          <div className="flex flex-col absolute inset-0 items-center justify-center text-center z-10 p-6">
            ...
            <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
              <button className="bg-[#E8B923] text-black border border-red-500 hover:bg-red-50 px-6 py-3 rounded-md transition-colors">
                Learn More
              </button>
              <button className="bg-[#C72E2E] text-white border border-blue-500 px-6 py-3 rounded-md transition-colors">
                Get Involved
              </button>
            </div>
          </div>
